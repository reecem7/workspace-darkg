...
This is a workspace for ChiliPeppr's Hardware Fiddle. It is geared towards CNC machines using TinyG.  I've added a dark theme based on bootswatch cyborg by Thomas Park and a tablet mode that can be accessed via the main workspace menu.
...
| Description           | This is a workspace for ChiliPeppr's Hardware Fiddle. It is geared towards CNC machines using TinyG.  I've added a dark theme based on bootswatch cyborg by Thomas Park and a tablet mode that can be accessed via the main workspace menu. |
...
| Github URL            | http://github.com/voodoomm/workspace-tinyg-darkness |
| Test URL              | https://preview.c9users.io/voodoomm/workspace-tinyg-darkness/workspace.html |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/voodoomm/workspace-tinyg-darkness/master/auto-generated-workspace.html",
  function() {
