...
cpdefine("inline:com-chilipeppr-workspace-tinyg", ["chilipeppr_ready"], function() {
    return {
        ...
        desc: `This is a workspace for ChiliPeppr's Hardware Fiddle. It is geared towards CNC machines using TinyG.  I've added a dark theme based on bootswatch cyborg by Thomas Park and a tablet mode that can be accessed via the main workspace menu.`,
         ...
         */
        init: function() {
            $('link[href="//netdna.bootstrapcdn.com/bootstrap/3.1.1/css/bootstrap.min.css"]').remove(); //attr('href','//maxcdn.bootstrapcdn.com/bootswatch/3.3.6/cyborg/bootstrap.min.css');
